...
public:
    ...
    static CanFrame BuildEmergency(uint8_t nodeId, uint16_t errorCode, 
                                  uint8_t errorRegister, uint32_t manufacturerData = 0) noexcept;
     ...
     * @return Populated CAN frame
     */
    static CanFrame BuildManufacturerSpecific(uint8_t nodeId, uint8_t functionCode,
                                             const uint8_t* data, uint8_t dataLength) noexcept;
     ...
     */
    static uint8_t BuildMotorEnableSequence(uint8_t nodeId, CanFrame* frames, uint8_t maxFrames) noexcept;
     ...
     * @return Number of frames in the sequence
     */
    static uint8_t BuildMotorDisableSequence(uint8_t nodeId, CanFrame* frames, uint8_t maxFrames) noexcept;
     ...
     * @return Populated CAN frame
     */
    static CanFrame BuildInterpolationPeriod(uint8_t nodeId, uint8_t subIndex, uint8_t value) noexcept;
     ...
     */
    static uint8_t BuildBLDCConfigSequence(uint8_t nodeId, CanFrame* frames, uint8_t maxFrames,
     ...
     */
    static bool ExtractSDOIndex(const CanFrame& frame, uint16_t& index, uint8_t& subIndex) noexcept;
